  ...
  return (
    <div className="min-h-screen overflow-hidden relative bg-gradient-to-br from-[#FEFBFB] via-white to-[#F8F6FF]">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-8 pb-16">
        <h2 className="text-3xl font-bold text-center mb-10 bg-gradient-to-r from-[#4A4A4A] to-[#6A5A6A] bg-clip-text text-transparent">
          How It Works
        </h2>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/50">
            <div className="w-10 h-10 bg-gradient-to-r from-[#D4A5A5] to-[#C49494] rounded-xl flex items-center justify-center mb-4 shadow-md">
              <span className="text-white font-bold">1</span>
            </div>
            <h3 className="font-bold text-[#4A4A4A] mb-2">Upload a video</h3>
            <p className="text-sm text-[#6A6A6A]">Record your movement from your phone. Video is processed locally in your browser.</p>
          </div>
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/50">
            <div className="w-10 h-10 bg-gradient-to-r from-[#B8A9C9] to-[#A598B8] rounded-xl flex items-center justify-center mb-4 shadow-md">
              <span className="text-white font-bold">2</span>
            </div>
            <h3 className="font-bold text-[#4A4A4A] mb-2">Get instant analysis</h3>
            <p className="text-sm text-[#6A6A6A]">Our computer vision extracts 12 joint angles, tracks speed and velocity, and scores your movement.</p>
          </div>
          <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/50">
            <div className="w-10 h-10 bg-gradient-to-r from-[#7DB9A3] to-[#6AA892] rounded-xl flex items-center justify-center mb-4 shadow-md">
              <span className="text-white font-bold">3</span>
            </div>
            <h3 className="font-bold text-[#4A4A4A] mb-2">Receive a clinical report</h3>
            <p className="text-sm text-[#6A6A6A]">Automated scoring with research-backed thresholds, ready for your provider.</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-8 pb-16">
        <div className="bg-white/50 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/50">
          <h3 className="font-bold text-[#4A4A4A] mb-4 text-center">Built With</h3>
          <div className="space-y-2 text-sm text-[#6A6A6A]">
            <p>Powered by MediaPipe pose estimation</p>
            <p>Scoring based on Butler et al. (2010) and Heredia et al. (2021) research</p>
            <p>Open source — <a href="https://github.com/Jolieabadir/dynalytics" target="_blank" rel="noopener noreferrer" className="text-[#7DB9A3] hover:text-[#6AA892] underline underline-offset-2">view on GitHub</a></p>
          </div>
        </div>
      </section>
          ...
          <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-12 shadow-2xl border border-white/60">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-[#6A6A6A] max-w-2xl mx-auto leading-relaxed">
                ...
                Help us transform how athletes understand their movement.
              </p>
            </div>
