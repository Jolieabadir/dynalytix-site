...
export default function ClimbingMethodologyPage() {
  return (
    <div className="min-h-screen overflow-hidden relative bg-gradient-to-br from-[#FEFBFB] via-white to-[#F8F6FF]">
      ...
      <nav className="relative z-10 flex justify-between items-center px-8 py-6 max-w-6xl mx-auto backdrop-blur-md bg-white/20 rounded-full mt-6 border border-white/20 shadow-lg shadow-black/5">
        <Link href="/methodology" className="flex items-center gap-3 group">
      ...
      {/* Section A: Why Data Collection Matters */}
      <section className="relative z-10 max-w-5xl mx-auto px-8 py-16">
        <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/50">
          ...
          <div className="space-y-6 text-[#6A6A6A] leading-relaxed text-lg">
            ...
            <p>
              <span className="font-semibold text-[#4A4A4A]">Dynalytix is building the first open dataset of climbing biomechanics.</span> Every video generates 40+ data points per frame — joint angles, speeds, velocities, body positions — all labeled with move types, sensation data, and quality ratings.
            </p>

            <p>This data does two things:</p>
          </div>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-8 py-16">
        <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/50">
          ...
          {/* Automatic Data */}
          <h3 className="text-2xl font-bold text-[#4A4A4A] mb-6">Automatic <span className="text-base font-normal text-[#6A6A6A]">(extracted by computer vision)</span></h3>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-10">
            <div className="bg-white/50 rounded-xl p-5 border border-white/60">
              ...
              <p className="text-sm text-[#6A6A6A]">Left/right elbow, shoulder, hip, knee, ankle, plus upper and lower back angles.</p>
            </div>
            ...
            <div className="bg-white/50 rounded-xl p-5 border border-white/60">
              ...
              <p className="text-sm text-[#6A6A6A]">Full body tracking with x, y, z coordinates and visibility confidence.</p>
            </div>
            ...
            <div className="bg-white/50 rounded-xl p-5 border border-white/60">
              ...
              <p className="text-sm text-[#6A6A6A]">Center of mass, individual landmarks, wrist/hip velocity vectors.</p>
            </div>
            ...
            <div className="bg-white/50 rounded-xl p-5 border border-white/60">
              ...
              <p className="text-sm text-[#6A6A6A]">All exported as CSV with frame number and timestamp.</p>
            </div>
          </div>

          {/* You Label */}
          <h3 className="text-2xl font-bold text-[#4A4A4A] mb-6">You Label</h3>
          ...
          <div className="space-y-4 mb-10">
            ...
            <div className="flex items-start gap-4 bg-white/50 rounded-xl p-5 border border-white/60">
              ...
              <div>
                <h4 className="font-bold text-[#4A4A4A] mb-1">Quality Rating & Effort Level</h4>
                <p className="text-sm text-[#6A6A6A]">1–5 form quality score and 0–10 perceived effort per move</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white/50 rounded-xl p-5 border border-white/60">
              ...
              <div>
                ...
                <p className="text-sm text-[#6A6A6A]">9 types (Sharp Pain, Dull Pain, Pop, Unstable, Stretch/Awkward, Strong/Controlled, Weak, Pumped, Fatigue) with body part and intensity</p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-[#7DB9A3]/10 to-[#6AA892]/10 rounded-2xl p-6 border border-[#7DB9A3]/20">
            <div className="flex items-start gap-4">
              ...
              <p className="text-[#4A4A4A]">
                <span className="font-semibold">Video never leaves your browser.</span> MediaPipe JS runs pose extraction entirely client-side — we only store the extracted pose data and your labels, never the video.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-8 py-16">
        <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/50">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-[#6A6A6A]">
                ...
                <tr className="border-b border-[#F0F0F0]">
                  ...
                  <td className="py-4 px-4">Complex movements like climbing</td>
                ...
                <tr>
                  ...
                  <td className="py-4 px-4">Rules + supervised + unsupervised</td>
          ...
          <div className="bg-gradient-to-r from-[#D4A5A5]/10 to-[#B8A9C9]/10 rounded-2xl p-6 border border-[#D4A5A5]/20">
            <p className="text-[#4A4A4A]">
              <span className="font-semibold">We&apos;re currently in the data collection phase.</span> The rule-based scoring engine (used in the clinical assessment tool) works today. The ML models are next.
            </p>
          </div>
        </div>
      </section>

      {/* Section D: The Data Flywheel */}
      <section className="relative z-10 max-w-5xl mx-auto px-8 py-16">
        <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-2xl border border-white/50">
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#4A4A4A] to-[#6A5A6A] bg-clip-text text-transparent mb-6">
            The Data Flywheel
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-[#7DB9A3]/10 to-[#6AA892]/5 rounded-2xl p-6 border border-[#7DB9A3]/20">
              ...
              <p className="text-sm text-[#6A6A6A]">Diversity of body types, climbing styles, and skill levels makes the model more robust.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#B8A9C9]/10 to-[#A598B8]/5 rounded-2xl p-6 border border-[#B8A9C9]/20">
              ...
              <p className="text-sm text-[#6A6A6A]">A pattern in your data might prevent someone else&apos;s injury.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#D4A5A5]/10 to-[#C49494]/5 rounded-2xl p-6 border border-[#D4A5A5]/20">
              ...
              <p className="text-sm text-[#6A6A6A]">Syncs to a public GitHub repo (dynalytix-data). Researchers can access it.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#6A6A6A]/10 to-[#5A5A5A]/5 rounded-2xl p-6 border border-[#6A6A6A]/20">
              ...
              <p className="text-sm text-[#6A6A6A]">Free access to personalized insights when ML models go live.</p>
            </div>
          </div>
        </div>
      </section>
